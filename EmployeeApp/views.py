...
from EmployeeApp.models import Patient, Employee, Consultation
from EmployeeApp.api.serializers import PatientSerializer, EmployeeSerializer, ConsultationSerializer
